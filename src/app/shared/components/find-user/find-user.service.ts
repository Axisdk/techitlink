...
export class FindUserService {
  public users$: BehaviorSubject<UserInterface[] | undefined> = new BehaviorSubject<UserInterface[] | undefined>(undefined)
  ...
  public getUsers(name: string | null): void {
    const users: UserInterface[] =
      this._userService.getUsers().filter((user: UserInterface) => user.id !== this._userService.getIdThisUser())
